...
public:
	...
	/// \brief Sets the timer event interval in nanoseconds.
	/// 
	/// The timer will begin calculating the event intervals beginning the
	...
	/// \brief Sleep the current thread until the next periodic event.
	void waitNext();
private:
